    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 animate-in fade-in duration-300">
      ...
      <div className="relative bg-white w-full max-w-md rounded-lg p-10 shadow-2xl animate-in slide-in-from-bottom-4 duration-500 overflow-hidden">
        ...
        <div className="space-y-3 mb-8">
          <button className="w-full flex items-center justify-center space-x-3 border border-black/10 py-3 rounded hover:bg-black/5 transition-all">
        ...
        >
          ...
          <button 
            type="submit"
            className="w-full bg-brand-ink text-white py-4 rounded text-[10px] tracking-widest uppercase font-bold hover:bg-brand-sage transition-all shadow-sm"
          >
            {isRegister ? 'Continue to Preferences' : 'Sign In'}
          </button>
        </form>
